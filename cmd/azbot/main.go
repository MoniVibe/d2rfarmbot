...
func main() {
	...
	led.Sink = func(o verbs.Outcome) {
		...
		if o.Result != verbs.ResDone || o.Verb == "intent" || o.Verb == "escalate" ||
			...
			o.Verb == "quest" || o.Verb == "stash" || o.Verb == "identify" || o.Verb == "fence" || o.Verb == "belt" || o.Verb == "door" || o.Verb == "stand" || o.Verb == "waypoint" || o.Verb == "loot" || o.Verb == "buff" || o.Verb == "trap" || o.Verb == "voyage" { // the new objectives and errands speak (R19: all silent)
