...
func (t *Travincal) Run() error {
	t.ctx.Logger.Info("Travincal run: current location read from memory",
		"currentAreaID", int(t.ctx.Data.PlayerUnit.Area),
		"posX", t.ctx.Data.PlayerUnit.Position.X,
		"posY", t.ctx.Data.PlayerUnit.Position.Y,
	)
	defer func() {
